...
<body>
	...
	<div class="video-header wrap">
		<div class="fullscreen-video-wrap">
			<video src="${contextPath}/resources/css/Pexels.mp4" autoplay="" loop="" muted=""></video>
		</div>
		<div class="header-overlay">
			<div class="header-content">				
				<form:form
					action="${contextPath}/addInterestingPlace/${route.user}?${_csrf.parameterName}=${_csrf.token}"
					modelAttribute="iplace" method="post" enctype="multipart/form-data">
					<div align="center">
				...
				<div id="mySidenav" class="sidenav">
					<a
						...
						id="details">My Route</a> <a href="/StarterKit/" id="about">Home</a>
					<a href="${contextPath}/favourite/${pageContext.request.userPrincipal.name}"
						id="blog">My favourite</a> <a
